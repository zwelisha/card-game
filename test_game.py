...
class TestCalculatePlayerScore(unittest.TestCase):
    def test_calculate_player_score(self):
        player_cards1 = ['10_of_clubs', '13_of_clubs', '5_of_clubs', '3_of_hearts', '12_of_hearts']
        player_cards2 = ['4_of_diamonds', '6_of_diamonds', '6_of_hearts', '4_of_hearts', '13_of_diamonds']
        player_cards3 = ['10_of_hearts', '9_of_hearts', '13_of_spades', '7_of_diamonds', '8_of_spades']
        player_cards4 = ['8_of_diamonds', '3_of_diamonds', '11_of_hearts', '2_of_spades', '13_of_clubs']
        player_cards5 = ['12_of_diamonds', '14_of_diamonds', '3_of_clubs', '5_of_diamonds', '4_of_spades']
